	...
	return server.ServerTool{
		...
		Handler: func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
			...
			err := helpers.ParamGroup(request.GetArguments(),
				...
				helpers.OptionalPointerParam(&companyUpdateRequest.AddressOne, "address-one"),
				helpers.OptionalPointerParam(&companyUpdateRequest.AddressTwo, "address-two"),
				...
				helpers.OptionalPointerParam(&companyUpdateRequest.CountryCode, "country-code"),
				helpers.OptionalPointerParam(&companyUpdateRequest.Phone, "phone"),
				helpers.OptionalPointerParam(&companyUpdateRequest.Fax, "fax"),
				helpers.OptionalPointerParam(&companyUpdateRequest.EmailOne, "email-one"),
				helpers.OptionalPointerParam(&companyUpdateRequest.EmailTwo, "email-two"),
				helpers.OptionalPointerParam(&companyUpdateRequest.EmailThree, "email-three"),
				...
				helpers.OptionalNumericPointerParam(&companyUpdateRequest.ManagerID, "manager-id"),
				helpers.OptionalNumericPointerParam(&companyUpdateRequest.IndustryID, "industry-id"),
				helpers.OptionalNumericListParam(&companyUpdateRequest.TagIDs, "tag-ids"),
			)
			if err != nil {
				return mcp.NewToolResultErrorFromErr("invalid parameters", err), nil
			}
